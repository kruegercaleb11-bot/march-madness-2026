...
export const TEAMS: TeamInput[] = [
  ...
  { name: "Louisville",     kenpomRank: 11, adjO: 14,  adjD: 30,  adjEM: 25.60, net: 14,  sos: 17,  trend: "down",   status: "INJURY_FLAG",        espnPct: 0.4  },
  { name: "Nebraska",       kenpomRank: 12, adjO: 54,  adjD: 5,   adjEM: 24.30, net: 13,  sos: 22,  trend: "steady", status: "Upset_Risk",         espnPct: 1.8  },
  { name: "BYU",            kenpomRank: 13, adjO: 11,  adjD: 19,  adjEM: 23.10, net: 23,  sos: 19,  trend: "up",     status: "Darkhorse",          espnPct: 0.9  },
